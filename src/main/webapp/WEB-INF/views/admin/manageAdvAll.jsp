    ...
    <div id="modakbul-outer-wrapper">
      ...
      <div id="modakbul-inner-wrapper" class="flex">
		...
		<div class="cont-wrap">
			...
			<div class="nav-wrap">
				<div class="manageGroup-nav selected"><a href="${pageContext.request.contextPath}/admin/manageAdvAll">전체</a></div>
			...
			<div id="advAll" class="content">
				<table>
					...
					<c:when test="${!empty requestScope.advAll}">
						<c:forEach var="adv" varStatus="status" items="${advAll.content}">
						<tr>
	...
	<c:set var="doneLoop" value="false"/>
		...
		<span class="pagination-inner"> 
		  <c:forEach var='i' begin='${startPage}' end='${(startPage-1)+blockCount}'> 
			    ...
			    <c:if test="${(i-1)>=advAll.getTotalPages()}">
		 ...
		 <c:if test="${(startPage+blockCount)<=advAll.getTotalPages()}">
