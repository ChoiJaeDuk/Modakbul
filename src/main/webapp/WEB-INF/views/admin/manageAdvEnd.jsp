      ...
      <div id="modakbul-inner-wrapper" class="flex">
		...
		<div class="cont-wrap">
			...
			<div class="nav-wrap">
				...
				<div id="nav2"><a href="${pageContext.request.contextPath}/admin/manageAdvRegis">신청대기</a></div>
				<div id="nav3"><a href="${pageContext.request.contextPath}/admin/manageAdvIng">진행중</a></div>
				<div id="nav4"><a href="${pageContext.request.contextPath}/admin/manageAdvEnd">종료</a></div>
			</div>
