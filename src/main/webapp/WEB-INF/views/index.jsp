...
<c:if test="${not empty pageContext.request.userPrincipal}">
	...
	<a href="${pageContext.request.contextPath }/user/mypageIndex/<sec:authentication property='principal.userNo'/>">프로필</a> 
    </sec:authorize>
...
<a href="${pageContext.request.contextPath}/admin/userList">유저 페이지 가기</a><p>
<a href="${pageContext.request.contextPath}/admin/gatherList">모임 페이지 가기</a><p>
<a href="${pageContext.request.contextPath}/admin/adList">광고 페이지 가기</a><p>
<a href="${pageContext.request.contextPath}/admin/adChart">광고 월별 매출 차트</a><p>
<a href="${pageContext.request.contextPath}/admin/userChart">유저 월별 증가 차트</a><p>
<a href="${pageContext.request.contextPath}/admin/categoryGatherChart">카테고리별 모임 개수 차트</a><p>
<a href="${pageContext.request.contextPath}/admin/adUploadForm">광고 업로드 폼</a><p>
</body>
</html>
