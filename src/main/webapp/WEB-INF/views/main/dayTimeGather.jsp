        ...
        <div class="search-list-top">
          <div class="search-list-main-filter">
            <ul class="search-list-main-filter-wrap">
              <li class="search-list-main-filter-item selected" onclick="location.href='${pageContext.request.contextPath}/main/dayTimeGather'">모임검색</li>
              <li class="search-list-main-filter-item " onclick="location.href='${pageContext.request.contextPath}/main/searchUserIndivForDaily'">회원검색</li>
            </ul>
            <div class="search">
