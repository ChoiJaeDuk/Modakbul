    ...
    <script type="text/javascript">
    	$(function(){
    		...
    		$("#search-btn").click(function(){
    			...
    			location.href="${pageContext.request.contextPath}/main/searchUserIndivForDaily/"+$("#search-text").val()
  ...
  <jsp:include page="/WEB-INF/views/layout/header.jsp" />
        ...
        <div class="search-list-top">
          ...
          <div class="search-list-main-filter">
            <ul class="search-list-main-filter-wrap">
              <li class="search-list-main-filter-item" onclick="location.href='${pageContext.request.contextPath}/main/dayTimeGather'">모임검색</li>
              <li class="search-list-main-filter-item selected" onclick="location.href='${pageContext.request.contextPath}/main/searchUserIndivForDaily'">회원검색</li>
            </ul>
	...
	<c:set var="doneLoop" value="false"/>
		  ...
		  <c:if test="${(startPage-blockCount) > 0}"> <!-- (-2) > 0  -->
		      <a class="pagination-newer" href="${pageContext.request.contextPath}/main/searchUserIndivForDaily/${keyword}?nowPage=${startPage-1}">PREV</a>
		  </c:if>
		...
		<span class="pagination-inner"> 
		  ...
		  <c:if test="${not doneLoop}" >
		         <a class="${i==nowPage?'pagination-active':page}" href="${pageContext.request.contextPath}/main/searchUserIndivForDaily/${keyword}?nowPage=${i}">${i}</a> 
		  </c:if>
		 ...
		 <c:if test="${(startPage+blockCount)<=userList.getTotalPages()}">
		     <a class="pagination-older" href="${pageContext.request.contextPath}/main/searchUserIndivForDaily/${keyword}?nowPage=${startPage+blockCount}">NEXT</a>
		 </c:if> 
		</c:if>		 
