      ...
      <div id="profile-inner-wrapper" class="divi">
        ...
        <div class="profile-content">
          <!-- 여기에 내용 넣으면 됨 -->
			...
			<h3 onclick="location.href='${pageContext.request.contextPath}/userProfile/profileGather/${user.userNo }?loginUserNo=${loginUserNo }'">주최모임</h3>
			</div>
			<div class="checkUserSubject">
			<h3 onclick="location.href='${pageContext.request.contextPath}/userProfile/profileReview/${user.userNo }?loginUserNo=${loginUserNo }'" style="color: lightgray">후기</h3>
			</div>
			</nav>
			</div>
