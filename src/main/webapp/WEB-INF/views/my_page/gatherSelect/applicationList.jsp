 ...
 <nav class="pagination-container">
	...
	<c:set var="doneLoop" value="false"/>
		 ...
		 <c:if test="${(startPage-blockCount) > 0}"> <!-- (-2) > 0  -->
		      <a class="pagination-newer" href="${pageContext.request.contextPath}/my_page/gatherSelect/applicationList?userNo=6&nowPage=${startPage-1}">PREV</a>
		  </c:if> 
		...
		<span class="pagination-inner"> 
		  ...
		  <c:if test="${not doneLoop}" >
		         <a class="${i==nowPage?'pagination-active':page}" href="${pageContext.request.contextPath}/my_page/gatherSelect/applicationList?userNo=6&nowPage=${i}">${i}</a> 
		  </c:if>
		 ...
		 <c:if test="${(startPage+blockCount)<=applicationList.getTotalPages()}">
		     <a class="pagination-older" href="${pageContext.request.contextPath}/my_page/gatherSelect/applicationList?userNo=6&nowPage=${startPage+blockCount}">NEXT</a>
		 </c:if>
