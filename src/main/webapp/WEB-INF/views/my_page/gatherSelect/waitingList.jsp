        ...
        <div class="my-page-content-wrap">
          ...
          <section class="my-page-main-content">
            <div class="class-search">
                <div class="filter-wrap">
	                ...
	                <div class="filter-list-wrap selected" id="host">
                        <div class="filter-list-item selected" data-tab="tab-4" id="recruitmentList" onclick="location.href='${pageContext.request.contextPath}/my_page/gatherSelect/waitingList?userNo=6';">신청목록</div>
                        <div class="filter-list-item" data-tab="tab-5" id="waitingList" onclick="location.href='${pageContext.request.contextPath}/my_page/gatherSelect/recruitingList?userNo=6';">모집중</div>
            ...
            <!-- 주최자 -->
                ...
                <div class="table-wrap selected" id="tab-4">
                    <table class="table">
                        <colgroup>
                            <col width="8%" />
                            <col width="37%" />
 ...
 <nav class="pagination-container">
	...
	<c:set var="doneLoop" value="false"/>
		 ...
		 <c:if test="${(startPage-blockCount) > 0}"> <!-- (-2) > 0  -->
		      <a class="pagination-newer" href="${pageContext.request.contextPath}/my_page/gatherSelect/waitingList?userNo=6&nowPage=${startPage-1}">PREV</a>
		  </c:if> 
		...
		<span class="pagination-inner"> 
		  ...
		  <c:if test="${not doneLoop}" >
		         <a class="${i==nowPage?'pagination-active':page}" href="${pageContext.request.contextPath}/my_page/gatherSelect/waitingList?userNo=6&nowPage=${i}">${i}</a> 
		  </c:if>
		 ...
		 <c:if test="${(startPage+blockCount)<=waitingList.getTotalPages()}">
		     <a class="pagination-older" href="${pageContext.request.contextPath}/my_page/gatherSelect/waitingList?userNo=6&nowPage=${startPage+blockCount}">NEXT</a>
		 </c:if>
