            ...
            <div class="class-search">
                <div class="filter-wrap">
	               ...
	               <div class="filter-list-wrap selected" id="host">
                        <div class="filter-list-item selected" data-tab="tab-5" id="waitingList" onclick="location.href='${pageContext.request.contextPath}/my_page/gatherSelect/waitingList?userNo=${user.userNo}'">신청목록</div>
