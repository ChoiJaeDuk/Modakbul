 ...
 <nav class="pagination-container">
	...
	<c:set var="doneLoop" value="false"/>
		 ...
		 <c:if test="${(startPage-blockCount) > 0}"> <!-- (-2) > 0  -->
		      <a class="pagination-newer" href="${pageContext.request.contextPath}/my_page/gatherSelect/upcomingList?userNo=${user.userNo }&nowPage=${startPage-1}">PREV</a>
		  </c:if> 
		...
		<span class="pagination-inner"> 
		  ...
		  <c:if test="${not doneLoop}" >
		         <a class="${i==nowPage?'pagination-active':page}" href="${pageContext.request.contextPath}/my_page/gatherSelect/upcomingList?userNo=${user.userNo }&nowPage=${i}">${i}</a> 
		  </c:if>
		 ...
		 <c:if test="${(startPage+blockCount)<=upcomingList.getTotalPages()}">
		     <a class="pagination-older" href="${pageContext.request.contextPath}/my_page/gatherSelect/upcomingList?userNo=${user.userNo }&nowPage=${startPage+blockCount}">NEXT</a>
		 </c:if>
