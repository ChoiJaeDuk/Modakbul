			...
			<div class="my-page-content-wrap">
				<nav>
					<ul>
						...
						<li class="my-page-nav-item"
							onclick="location.href='${pageContext.request.contextPath}/my_page/alarm/myAlarm?userNo=${user.userNo}'">알림함</li>
						<li class="my-page-nav-item "
						...
						<div class="table-wrap selected" id="tab-1">
							<table class="table">
								...
								<tbody>
									...
									<c:choose>
										<c:when
											test="${0 eq requestScope.reviewStatusCompleteList.getTotalPages()}">
											<tr>
												<td colspan="5">작성된 후기가 없어요 🔥</td>
											</tr>
										</c:when>
										<c:otherwise>
						...
						<div style="text-align: center">
							...
							<nav class="pagination-container">
								<div class="pagination">
									...
									<span class="pagination-inner"> <c:forEach var='i'
											...
											<c:if test="${not doneLoop}">
												<a class="${i==nowPage?'pagination-active':page}"
													href="${pageContext.request.contextPath}/my_page/my_page_review_complete?userNo=${user.userNo}&nowPage=${i}">${i}</a>
											</c:if>
									...
									<c:if
										test="${(startPage+blockCount)<=reviewStatusCompleteList.getTotalPages()}">
