...
<html lang="ko">
  <head>
    ...
    <link href="${pageContext.request.contextPath}/css/my-page-inquiry/index.css" rel="stylesheet" />
    <link href="${pageContext.request.contextPath}/css/my-page-inquiry/reset.css" rel="stylesheet" />
          ...
          <section class="my-page-main-content">
            ...
            <div class="inquiry">
                <table class="table">
                    ...
                    <tbody>
                    <c:forEach var="inquiry" items="${requestScope.inquiryList.content}" varStatus="status">
