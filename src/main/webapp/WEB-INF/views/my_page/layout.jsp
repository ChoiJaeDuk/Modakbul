	...
	<div class="wrap">
	 ...
	 <div id="my_modal">
	 	<table id="following" style="width: 520px;">
			...
			<td style="width: 20%">
			<button class="modakbul-button following active" id="" value="">팔로우</button>
			</td>
			</tr> 	
			<c:forEach items="${followingList}" var="f">
				<tr>
					...
					<td style="width: 20%">
						<button class="modakbul-button following" id="${f.followerUser.userNo}" value="${f.followerUser.userNo}">팔로잉</button>
					</td>
				</tr>
			</c:forEach>
	 	</table>
