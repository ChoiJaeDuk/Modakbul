            ...
            <div class="class-search">
                <div class="filter-wrap">
                    <div class="filter-list-wrap">
                        <div class="filter-list-item selected">신청가능모임</div>
                        <div class="filter-list-item">신청대기</div>
                        <div class="filter-list-item">광고진행중</div>
                        <li class="filter-list-item selected"><a class="filter-list-item selecte"
							data-toggle="tab" href="#description" role="tab">신청가능모임</a></li>
							
							<li class="filter-list-item"><a class="filter-list-item"
							data-toggle="tab" href="#information" role="tab">신청대기</a></li>
                    </div>
                </div>
                <div class="commercial" id="description" role="tabpanel">
                    <table class="table">
                        <colgroup>
                            <col width="8%" />
                            <col width="37%" />
                        ...
                        <tbody>
                            <tr class="table-body">
                                ...
                                <td class="inquiry-replied">
                                    <button class="my-page-button">광고신청</button>
                                </td>
                            </tr>
                            <tr class="table-body">
                                <td>2</td>
                ...
                <div class="commercial-wait" id="information">
                    <table class="table">
                        <colgroup>
                            <col width="8%" />
                            <col width="37%" />
