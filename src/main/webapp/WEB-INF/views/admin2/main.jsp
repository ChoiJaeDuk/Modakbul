 ...
 <nav class="pagination-container">
	...
	<c:set var="doneLoop" value="false"/>
		  ...
		  <c:if test="${(startPage-blockCount) > 0}"> <!-- (-2) > 0  --> <!--양수가 나오면 이전이 있다-->
		      <a class="pagination-newer" href="${pageContext.request.contextPath}/admin2/main?nowPage=${startPage-1}">PREV</a>
		  </c:if>
		...
		<span class="pagination-inner"> 
		 ...
		 <c:if test="${(startPage+blockCount)<=pageList.getTotalPages()}">
		     <a class="pagination-older" href="${pageContext.request.contextPath}/admin2/main?nowPage=${startPage+blockCount}">NEXT</a>
		 </c:if>
