...
public class MailSendServiceImpl implements MailSendService {
	...
	@Override
	public MimeMessage createMessage(String to, String state) throws MessagingException, UnsupportedEncodingException {
		...
		if(state.equals("join")) {
			...
			message.setSubject("모닥불 회원 비밀번호 찾기");
			...
			content += "<h1> 즐거운 모임을 가지자 모닥불 입니다 </h1>";
			content += "<br>";
			content += "<p>아래 임시번호로 비밀번호가 변경되었습니다..<p>";
			content += "<br>";
			content += "<div align='center' style='border:1px solid black; font-family:verdada';>";
			content += "<h3 style='color:blue;'>임시비밀번호입니다.</h3>";
			content += "<div style='font-size:130%'>";
			content += "CODE : <strong>";
			content += ePw + "</strong><div><br/>";
			content += "</div>";
	...
	@Override
	public String sendSimpleMessage(String to, String state) throws Exception {
		
		ePw = createKey();
		
		MimeMessage message = createMessage(to, state);
		try {
